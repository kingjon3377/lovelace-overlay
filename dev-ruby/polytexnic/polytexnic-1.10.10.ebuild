...
ruby_add_bdepend "test? ( dev-ruby/rspec:3 )" # dev-ruby/simplecov:0.8 patched out
ruby_add_bdepend "dev-ruby/rake"

PATCHES=(
	"${FILESDIR}/${P}-1-Upgrade-to-RSpec-3-fix-matcher-incompabilility.patch"
	"${FILESDIR}/${P}-2-Suppress-warning-when-calling-.not_to-raise_error.patch"
	"${FILESDIR}/${P}-3-Update-tests-to-catch-exceptions-to-remove-deprecati.patch"
	"${FILESDIR}/${P}-4-Eliminate-remaning-deprecation-warnings.patch"
	"${FILESDIR}/${PN}-1.6.1-drop-coverage.patch"
)
