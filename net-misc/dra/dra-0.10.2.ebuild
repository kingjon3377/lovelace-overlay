...
SRC_URI="https://github.com/devmatteini/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tgz
	${CARGO_CRATE_URIS}"

# License set may be more restrictive as OR is not respected
# use cargo-license for a more accurate license picture
LICENSE="0BSD Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD BZIP2 Boost-1.0 CDLA-Permissive-2.0 ISC MIT Unicode-3.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
IUSE="test"
