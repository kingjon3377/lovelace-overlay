...
KEYWORDS="~amd64"
DEF_ON_FLAGS=( bzip2 cairo curl desktop gtk imageio media mime ncurses net
				opengl pcre pdf qt5 sdl sdlsound sqlite svg v4l xml zlib )
DEF_OFF_FLAGS=( crypt dbus examples gmp gsl httpd imageimlib jit mysql
